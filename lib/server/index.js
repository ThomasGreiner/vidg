            ...
            if (params.filter) {
              ...
              switch (key) {
                ...
                case "samecolors": {
                  ...
                  let sameColors = new Set();
                  this._index.each((entry) => {
                    let colors = entry.stats.colors.join("");
                    if (allColors.has(colors)) {
                      sameColors.add(colors);
                    } else {
                      allColors.add(colors);
                    }
                  });
                  this._index.filter((entry) => sameColors.has(entry.stats.colors.join("")));
                  break;
                }
                case "sameduration": {
                  if (!value)

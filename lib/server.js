    ...
    switch (req.method) {
      case "GET": {
        ...
        switch (urlpath) {
          ...
          case "/current":
            return this._getFile(this._cursor.current);
          case "/empty-trash":
            return this._db.emptyTrash()
                .then(() => this.start())
                .then(() => this._getFile("current"));
          case "/next":
            return this._getFile(this._cursor.next());
          case "/next-unrated":
            return this._getFile(this._cursor.next({rated: false}));
          case "/prev":
            return this._getFile(this._cursor.previous());
        }
        break;
      }
      case "POST": {
